            ...
            <nav class="grid">
                ...
                <div class="header__off-screen-menu">
                    <ul class="grid mt-12 ml-2 sm-mt-2">
                        <li class="sm-col-span-4 md-col-span-3 lg-col-span-2 xl-col-start-2"><a href="#">What we do</a></li>
                        ...
                        <li class="sm-col-span-4 md-col-span-3 lg-col-span-1 xl-col-start-9"><a href="#">Our Company</a></li>
...
<main>
    <div class="contact grid" >
        <div class="wrapper wrapper--narrow grid">
            <div class="contact__info grid lg-col-start-1 lg-col-end-6">
            ...
            <div class="contact__form grid lg-col-start-6">
                ...
                <form action="" class="contact__form-fields grid pb-10">
                    ...
                    <!-- Submit button -->
                    <div class="contact__form-group col-start-4 col-end-12 lg-col-start-1">
    ...
    <div class="logos mb-10 mt-10">
        <div class="wrapper wrapper--narrow">
                ...
                <img src="assets/logos/logosMobile.png" class="logos__mobile p-3" alt="">
        </div>
    </div>
